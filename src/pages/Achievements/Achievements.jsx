  ...
  return (
    <>
      <div className="text-center">
        <div className="text-center py-[70px] bg-cover  bg-[url('/src/assets/circuitlines.jpg')] fixed left-0 right-0 top-0">
        ...
        <div className="bg-white shadow-2xl  rounded-[12px] h-[427px] w-[367px]">
            <div className="px-2 py-2">
              ...
              <div className="text-start px-2 mt-2">
                <h1 className="font-[700] mb-3 text-[20px]">CONVERSION OF WASTE TO BIOFUEL</h1>
                <p className="w-[95%]">
                  Omnis maiores velit culpa sed corporis cum exercitationem sit
                  eum. Ea veritatis ...
                </p>
                <button className="px-3 py-2 mt-2 rounded-md text-primary font-[600] border border-solid">View Details</button>
              </div>
            </div>
          </div>
