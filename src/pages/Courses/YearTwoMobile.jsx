...
export const YeartwoMobile = (props)  => {
   ...
   <div onClick={handleShowTopics} className="bg-[#FAF8F8] cursor-pointer rounded-[8px] my-[4px]   py-[12px] px-[16px]  flex flex-row items-center  justify-between ">
            <div className="">
            ...
            <div className="flex flex-row justify-center gap-[10px]">
              <span className="text-[12px]">{props.unit}</span>
              <IoIosArrowForward />
            </div>
          </div>
          ...
          <div className="bg-[#FAF8F8] absolute  px-[37px]  h-[80vh] py-[25px] rounded-2xl top-[80px] overflow-y-scroll max-w-[350px] ">
            <h1 className="text-[20px] font-[700] my-[10px] ">Topics</h1>
            <Link to='/download'>
            <div className="flex flex-col items-start gap-[10px] ">
              <h2 className="text-[14px] font-[600] text-[#000000] ">
              {props.topic1H}
              </h2>
              <p className="font-[400] text-[14px] text-[#656565]  ">
               {props.topic1D}
              </p>
            </div>
            </Link>
            ...
            <div className="flex flex-col items-start gap-[10px] ">
              <h2 className="text-[14px] md:text-[20px] font-[600] text-[#000000] ">
              {props.topic4H}
              </h2>
              <p className="font-[400] text-[14px] text-[#656565]  ">
              {props.topic4D}
