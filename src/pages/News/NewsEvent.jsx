    ...
    <>
      ...
      <div className=" flex flex-col md:flex-row p-[30px] justify-center gap-[100px] items-start mt-[50px]">
        ...
        <div className="flex flex-col lg:hidden justify-center gap-[10px] items-center w-[100%]">
            ...
            <input type="search" placeholder="Search.." name=""  id="" className="w-[100%] outline-0"/>
            <IoMdSearch />
          </div>
          <div className="bg-[#F5F5F5]  rounded-[12px] p-[4px] flex flex-row justify-center items-start ">
            <button className="rounded-[8px] py-[17px] bg-darkest px-[20px] text-white ">News</button>
            <button className="rounded-[8px] text-darkest py-[17px] px-[20px] text-white ">Events</button>
          </div>
            </div>
          <div className=" shadow-xl py-[15px] px-[10px] border border-[#fff] gap-[10px]  flex lg:flex-col items-start rounded-[12px]">
            <img src={img} alt="news" className="w-[150px] rounded lg:w-[100%] " />
          ...
          <Link to='/nuesa'>
          <div className="shadow-xl px-[10px] py-[15px] border border-[#fff]  px-[10px] gap-[10px]  flex lg:flex-col items-start rounded-[12px]">
