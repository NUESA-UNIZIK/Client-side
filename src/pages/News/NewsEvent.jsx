...
export const NewsEvent = () => {
 ...
 <div className=" flex flex-col md:flex-row p-[30px] justify-center gap-[100px] items-start mt-[50px]">
   ...
   <div className="flex flex-col items-start gap-[22px max-w-[428px]">
    ...
    <p className="text-[20px] font-[700]  text-[#0000000] ">NUESA Inter-Departmental Football Cup kicks off</p>
   <span className="text-[14px] font-[700] leading-[150%] text-[#888888] ">13th Feb 2023</span>
   ...
   <div className="flex flex-col items-start gap-[22px] max-w-[428px]">
    <div className="flex flex-col gap-[5px] p-0 ">
    <h2 className="text-[20px] font-[700]  text-[#0000000] ">NUESA Inter-Departmental Football Cup kicks off</h2>
   <span className="text-[14px] font-[700] leading-[150%] text-[#888888] ">13th Feb 2023</span>
   <p className="font-[400] text-[16px] text-[#000000] ">Omnis maiores velit culpa sed corporis cum exercitationem sit eum. Ea veritatis et nihil corporis nobis rem ratione quia nemo.</p>
   ...
   <a className="text-[16px] font-[700] rounded-[8px] leading-[150%] text-[#092E76] py-[8px] px-[12px] border ">Read More</a>
   </div>
