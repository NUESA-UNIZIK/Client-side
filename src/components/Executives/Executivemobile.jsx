...
const Executivemobile = () => {
  ...
  return (
    <div className="bg-[#F5F5F5] block md:hidden py-4 h-[341px]">
      ...
      <Swiper
        ...
        className="productSlider   min-h-[420px]"
              ...
              <div className="grid grid-cols-1  mx-[1.9rem] justify-center items-center">
                {content.executiveslider.map((items, index) => {
                  return (
                    <div
                      key={index}
                      className="bg-white  w-[305px]  h-[229px]  mt-6 lg:mt-0 rounded-md px-3 py-4 lg:px-8 lg:py-6"
                    >
                      <div className="">
